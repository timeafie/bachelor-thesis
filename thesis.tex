...
\include{chapters/examples/stableUnabhängigkeit}
\include{chapters/examples/completeUnabhängigkeit}
\include{chapters/examples/preferredUnabhängigkeit}
\include{chapters/examples/Graphklassen}
\include{chapters/examples/Graphklassen_Analyse}
\include{chapters/examples/Graphklassen_preferred}
