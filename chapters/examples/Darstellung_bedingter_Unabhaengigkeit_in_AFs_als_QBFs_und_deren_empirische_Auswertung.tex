...
Stable- und Preferred-Semantik in einer gemeinsamen Darstellung. 
Zunächst wird der Begriff der bedingten Unabhängigkeit auf die
labellingbasierte Bewertung eines Argumentationssystems übertragen und die
Komplexität der daraus entstehenden Entscheidungsprobleme
eingeordnet. Anschließend werden einheitliche aussagenlogische
Bausteine entwickelt, aus denen sich die drei Semantikkodierungen
und eine gemeinsame QBF-Kodierung der Unabhängigkeit zusammensetzen. 
Abschließend wird empirisch untersucht, wie die Größe der Konditionierungsmenge \(Z\) 
mit Ergebnisverteilung und Solverlaufzeit zusammenhängt.
...
\section{Empirische Analyse des Einflusses der Konditionierungsmenge}
...
\section{Auswahl der Argumentationssysteme}
...
\section{Auswahl der Argumentpaare}
\label{sec:argument-pair-selection}
...
\section{Konstruktion der Konditionierungsmengen}
\label{sec:conditioning-set-construction}
...
\section{QBF-Erzeugung und technische Durchführung}
\label{sec:qbf-experimental-execution}
