...
\begin{proof}
    ...
    Dies folgt direkt aus Proposition \ref{prop:ocf-af-ci-st-pi^2} und der Tatsache, dass in ungeradezykelfreien AFs \(\Lambda_{st} = \Lambda_{pr}\).
\end{proof}
...
Wie die Tabelle~\ref{tab:komplexitaet-graphklassen} zusammenfassend zeigt, ist die
