...
\begin{proof}
    ...
    \(\varphi\leftrightarrow t\).Außerdem bseitzen die Klauselargumente keine
...
\begin{figure}
    ...
    AF-Repräsentation einer Instanz der Reduktion aus Proposition~C.1
...
\begin{Proposition}
    ...
    Die \(preferred\)-Unabhängigkeit ist auch in ungeradezykelfreien AFs \(\Pi_2^\text{P}\)-vollständig .
\end{Proposition}
...
\begin{Proposition}
    ...
    Die \(complete\)-Unabhängigkeit ist auch in ungeradezykelfreien AFs \(\Pi_2^\text{P}\)-vollständig.
\end{Proposition}
...
\begin{proof}
    ...
    setzen ferner \(\lambda_3(s)=\lambda_3(g)=und\). Jedes
...
Wie Tabelle~\ref{tab:komplexitaet-graphklassen} zusammenfasst, ist die
bedingte \(\sigma\)-Unabhängigkeit für \(\sigma\in\{co,st,pr\}\) auf
azyklischen und geradezykelfreien AFs trivial; jede Anfrage wird positiv
...
damit auf der zweiten Ebene der polynomialen Hierarchie.
