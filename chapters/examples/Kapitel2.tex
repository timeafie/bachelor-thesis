...
\begin{Definition}
    ...
    \begin{itemize}
        \item Die Menge der \emph{grounded}-Semantiken von F ist definiert durch 
        ...
        \item Die Menge der \emph{preferred}-Semantiken von F ist definiert durch 
        ...
        \item Die Menge der \emph{stable}-Semantiken von F ist defninert durch 
...
\begin{Definition}[QBF]
    ...
    \begin{enumerate}
        ...
        \item Ist \(\varPhi\) eine quantifizierte boolesche Formel, so sind \(\exists x \varPhi\) und 
        \(\forall x \varPhi\) quantifizierte boolesche Formeln
        \item Sind \(\varPhi_1\) und \(\varPhi_2\) quantifizierte boolesche Formel, so sind \(\neg \varPhi_1\), 
        \(\varPhi_1 \lor \varPhi_2\) und \(\varPhi_1 \land \varPhi_2\) quantifizierte boolesche Formeln.
...
\begin{Definition}[Zentrale Entscheidungsprobleme für AFs]
    ...
    gilt.
\end{Definition}
Die bekannten Ergebnisse sind in
Tabelle~\ref{tab:complexity-af-semantics} zusammengefasst
