...
\begin{Definition}[Grounded-, Preferred- und Stable-Labellings]
    ...
    \begin{itemize}
        ...
        \item Die Menge der \emph{stable}-Labellings von F ist defininert durch 
...
\begin{Definition}[Abhhängigkeitsmodell]
...
\end{Definition}
Anschaulich übersetzt \(R\) positive Instanzen von \(Q'\) in positive
...
QBF-Wahrheitsprobleme aus Abschnitt~\ref{sec:qbf}. Ihre Komplexität wird
