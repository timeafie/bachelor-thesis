...
Argumentationsszenario \enquote{überzeugende}, führt zum \emph{extensions}-basierten Ansatz. 
Eine \emph{Extension} ist dann genau die ausgewählte Argumentmenge. Je nach Semantik werden dann unterschiedliche 
und auch mehrere Kriterien gleichzeitig verwandt, um Menge an Argumenten auszuwählen. 

\begin{Definition}
      \label{def:extension}
      Eine \emph{Extension} $E \subseteq A$ ist eine Auswahl der Argumentmenge $A$, die bestimmte Eigenschaften erfüllt.
\end{Definition}
