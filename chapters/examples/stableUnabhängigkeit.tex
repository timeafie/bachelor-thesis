...
Rein formal handelt es sich um das folgende Entscheidungsproblem.
\begin{description}
    \item[]$\textit{Ind}_{\mathrm{st}}$
    \item[Input:] AF $F=(A,R)$, disjunkte Mengen $X,Y,Z \subseteq A$
    \item[Output:] TRUE $\Leftrightarrow X \bot_{\mathrm{st}} Y \mid Z$
\end{description}

Wir skizzieren den Beweis, angelehnt an \cite{bluemel:2025:independence-aba}. 
